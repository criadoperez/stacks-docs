...
"The rules governing the creation of new valid records in a blockchain database
 and the mining algorithms used for this purpose.
...
#### crypto-asset
A digital asset which utilises cryptography
 peer-to-peer networking
 and a public ledger to regulate the creation of new units
 verify transactions, and secure the transactions without the intervention of any middleman.
